...
import type { ParsedSession as ComputedSession } from '../lib/types.js';
...
const allData: Analytics = window.__ANALYTICS_DATA__;
    ...
    <div className="container">
      ...
      <div className="date-filter">
        ...
        <div className="date-filter-summary">
          Showing {data.totalSessions.toLocaleString()} of {allData.totalSessions.toLocaleString()} sessions
        </div>
      </div>
